...
import com.rslakra.appsuite.protocol.http.ContentEncodingRegistry;
import com.rslakra.appsuite.protocol.http.ContentType;
import com.rslakra.appsuite.protocol.http.HTTPUtils;
import com.rslakra.appsuite.protocol.http.HttpMethod;
import com.rslakra.appsuite.protocol.http.*;
...
public class RestBuilder {
    ...
    private final Payload<Object, Closure> responseHandlers;
    private ContentEncodingRegistry contentEncodingHandler;
    private final Payload<String, String> defaultHeaders;
    ...
    public RestBuilder(final Object defaultUri, final Object defaultContentType) throws URISyntaxException {
        ...
        this.responseHandlers = new Payload(this.buildDefaultResponseHandlers());
        this.contentEncodingHandler = new ContentEncodingRegistry();
        this.defaultHeaders = Payload.newBuilder();
...
// requestDelegate.setRequestContentType(ContentType.URLENC.toString());
     ...
     * @throws URISyntaxException
     */
    public Object request(final Object uri, final HttpMethod method, final Object contentType,
     ...
     * @throws IOException
     */
    protected Object doRequest(final URI uri, final HttpMethod httpMethod, final Object contentType,
                               final Closure configClosure)
        throws ClientProtocolException, IOException {
...
// }
     ...
     */
    public void setContentEncoding(final ContentEncoding.EncodingType... contentEncodingTypes) {
     ...
     * @param headers
     */
    public void setHeaders(final Payload headers) {
        getHeaders().clear();
        if (headers != null) {
     ...
     * @return
     */
    public Payload<String, String> getHeaders() {
...
// SSLConnectionSocketFactory.getSocketFactory().createLayeredSocket()
    ...
    protected class RequestDelegate {
        ...
        public RequestDelegate(final RestBuilder restBuilder, final HttpRequestBase request, final Object contentType,
            ...
            this.responseHandlers = Payload.newBuilder();
            this.headers = Payload.newBuilder();
